...
const PersonalityCarousel = ({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: bgColor, borderRadius: team ? "40px" : "0" }}
    >
      <div
        className=" font-family mb-5 text-center pt-5 pb-5 title-font"
            ...
            <Slider {...settings}>
              {personalities &&
                personalities.map((personality, index) => (
                  <div
                    className="row m-0 p-0justify-content-center"
                    key={index}
                  >
                    <div
                      className=""
